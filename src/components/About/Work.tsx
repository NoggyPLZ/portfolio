  ...
  return (
    <div className="">
      ...
      <ul className="list-disc pl-4 flex flex-col gap-2 pt-2">
        <li>
          Directed brand and web design for clients across music, retail, and
          professional services, handling engagements end to end from strategy
        ...
        <li>
          ...
          providing continued design support.
        </li>
        <li>
          Designed album artwork, iconography, and logo work for Nashville
          recording artist N. Justice across multiple releases, with covers
      ...
      <ul className="list-disc pl-4 flex flex-col gap-2 pt-2">
        <li>
          Directed design and front-end delivery for 250+ client websites,
          including national work for Tractor Supply Co., Ryman Hospitality
          Properties, Rite Aid, and Crunchyroll.
        </li>
        <li>
          Led art direction on enterprise recruitment and employer brand
          platforms serving workforces of up to 54,000 team members across 49
          states, translating business hiring problems into information
        ...
        <li>
          ...
          recruiting, and marketing, aligning competing internal audiences on a
          single approach.
        </li>
        <li>
        ...
        <li>
          ...
          owning scope, timeline, and creative quality.
        </li>
        <li>
