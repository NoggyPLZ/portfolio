...
export function AlchemyShape1(){
    ...
    useGSAP(()=>{
        gsap.timeline({
            ...
            .to(downTriangle.current, {opacity:1, duration:1.5, ease:"power2.in"})
            .to(upTriangle.current, {opacity:1, duration:.5, ease:"power2.in"}, '<')
            .to(innerTriangle.current, {opacity:1, duration:.5, ease:"power2.in"},'<')
            .to(innerTriangle.current, {fill:"#1c1e22", strokeWidth:0, duration:1, ease:"power2.in"},'<')
            .to(captureLines.current, {opacity:1, duration:.5, ease:"power2.in"})
    },{scope:container})
...
export function AlchemyShape2(){
    ...
    useGSAP(()=>{
        gsap.timeline({
            ...
            .fromTo(blackTriangle1.current, {y:-100}, {y:0, duration:1, ease:"power2.out"},'<')
            .fromTo(blackTriangle2.current, {opacity:0}, {opacity:1, duration:.5, ease:"power2.in"})
            .from(".white-line",{
                drawSVG:"0%",
                duration:.5,
                ease:"power2.in",
...
className="absolute -top-5 left-4/6 -translate-x-1/2 w-full md:w-8/12 xl:w-1/2">
  <polygon
...
export function AlchemyShape3(){
  ...
  useGSAP(()=>{
    ...
    const rightOriginY = 70.97 - rightBBox.y;
        ...
        gsap.timeline({
            ...
            .fromTo(centerTriangle.current, {opacity:0}, {opacity:1, duration:1, ease:"power2.in"},"<")
            .fromTo(leftAngle.current,
              {rotation:-10, opacity:0, transformOrigin:`${originX}px ${originY}px`},
              {rotation:0, opacity:1, duration:.5, ease:"power4.out"},"1")
            .fromTo(rightAngle.current,
              {rotation:30, opacity:0, transformOrigin:`${rightOriginX}px ${rightOriginY}px`},
              {rotation:0, opacity:1, duration:.5, ease:"power4.out"},"1")
            .fromTo(bottomAngle.current,{y:-50, opacity:0},{y:0, opacity:1, duration:.5, ease:"power4.Out"})
        }
    },{scope:container})
  ...
  className="top-1/2 left-10/12 xl:left-8/12 -translate-x-1/2 -translate-y-1/2 w-full md:w-8/12 lg:w-6/12 xl:w-7/24 absolute"
    ref={container}
>
  <polygon
...
export function AlchemyShape4(){
  ...
  useGSAP(()=>{
        gsap.timeline({
            ...
            .fromTo(blackTriangle.current, {y:-200}, {y:0, duration:1, ease:"power2.out"})
