...
export default function WorkSection(){
    return (
        ...
        {projects.map((project, index)  =>(
            <div key={index} className={`${index % 2 !== 0 ? 'bg-darkgray-500' : 'bg-palegray-500'}`}>
                <div className={`flex md:flex-row flex-col gap-8 p-8 border-t-30 border-b-30 border-darkgray-500`}>
