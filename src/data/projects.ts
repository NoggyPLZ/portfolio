...
const projects: Project[] = [
  ...
  },
  {
    ...
    skills:
      "React, Redux Toolkit, TypeScript, Tailwind CSS, Netlify Serverless Functions, Steam API, Design, Branding",
  ...
  },
  {
    ...
    skills:
      "Next.js, Typescript, Zod, React Hook Form, Server Actions, Prisma, PostgreSQL, Tailwind CSS, Design, Branding,",
