...
export default function Footer(){
    ...
    useGSAP(() =>{
        ...
        let split = SplitText.create(questionRef.current, {type:"chars, words"})
    ...
    return(
        <footer ref={containerRef} className="p-8 pt-16 pb-16 flex flex-col text-palegray-500 gap-8">
            <h1 ref={questionRef} className="pb-5 uppercase font-bigger 2xl:text-[14rem]/75 xl:text-[12rem]/40 md:text-[12rem]/40 text-[10rem]/33 border-b-palegray-500 border-b-1">Ready to solve some <span className='text-palered-500'>problems</span>?</h1>
